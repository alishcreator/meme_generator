...
class Temple4 extends StatefulWidget {
  @override
  _Temple4State createState() => _Temple4State();
}

class _Temple4State extends State<Temple4> {
  ...
  TextModel text1Details = new TextModel("text 1", "impact", Colors.white);
  TextModel text2Details = new TextModel("Text 2", "impact", Colors.white);
  TextModel text3Details = new TextModel("Text 3", "impact", Colors.white);
  ...
  FetchTextData3(TextModel textModel) {
    setState(() {
      text3Details = textModel;
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        alignment: Alignment.center,
                                        padding: EdgeInsets.all(6),
                                        child: TextStroke(text3Details, false),
                                      ),
                                    ),
                                  ],
                                ),
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        GestureDetector(
                          onTap: () async {
                            ShowTextPickerDialoge(context, FetchTextData3);
                          },
                          child: CircleButtonAndText("TEXT2", isTextSelected3),
                        ),
                        Container(
                          height: 40,
                        ...
                        GestureDetector(
                          ...
                          child: CircleButtonAndText("IMAGE2", isImagePicked3),
                        ),
                      ],
                    ),
                  ),
